...
def repeat_string(string1, number):
...
def total_meal_price(cost, percent_tip=0.15):
    return cost + cost * percent_tip
...
sign_parity = sign_and_parity(-7)
sign = sign_parity[1]
parity = sign_parity[0]
print sign, parity
